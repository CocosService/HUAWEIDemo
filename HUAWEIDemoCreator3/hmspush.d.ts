    ...
    namespace hms {
        namespace push {
            ...
            enum API_EVENT_LIST {
                ...
                startPushCallback = "startPushCallback",
                closePushCallback = "closePushCallback",
            ...
            class HmsPushService {
                ...
                */
                ...
                private _startPushCallback;
                /**
                 * 关闭推送
                 * 调用 SDK 的关闭推送方法。
                */
                closePush(appId: string): void;
                private _closePushCallback;
                /**
                 * 设置别名（不支持）
                 * 调用 SDK 的设置别名方法。
                */
                ...
                */
                 ...
                 * @internal
                 */
                _getAAIDCallback(result: any): void;
                /**
                 * 删除本地生成的AAID与时间戳并同步删除已生成的与本AAID相关的所有Token。
                */
                deleteAAID(): void;
                _deleteAAIDCallback(result: any): void;
                /**
                 * 获取是否启用自动初始化功能。
                */
